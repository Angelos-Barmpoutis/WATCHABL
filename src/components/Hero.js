    ...
    return (
        <div className="hero wrapper">
            ...
            <div className="hero__images">
                ...
                {heroTrending.length > 0 && <h3 className={circles === 0 ? "hero__images__title active" : 'hero__images__title'} onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd}  onClick={() => openModal(heroTrending[0].id, 'movie')}>{heroTrending[0].title}<span>{heroTrending[0].release_date.split('-', 1)}</span></h3>}
                {heroTrending.length > 0 && <h3 className={circles === 1 ? "hero__images__title active" : 'hero__images__title'} onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd} onClick={() => openModal(heroTrending[1].id, 'movie')}>{heroTrending[1].title}<span>{heroTrending[1].release_date.split('-', 1)}</span></h3>}
                {heroTrending.length > 0 && <h3 className={circles === 2 ? "hero__images__title active" : 'hero__images__title'} onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd} onClick={() => openModal(heroTrending[2].id, 'movie')}>{heroTrending[2].title}<span>{heroTrending[2].release_date.split('-', 1)}</span></h3>}
                {heroTrending.length > 0 && <h3 className={circles === 3 ? "hero__images__title active" : 'hero__images__title'} onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd} onClick={() => openModal(heroTrending[3].id, 'movie')}>{heroTrending[3].title}<span>{heroTrending[3].release_date.split('-', 1)}</span></h3>}
                {heroTrending.length > 0 && <h3 className={circles === 4 ? "hero__images__title active" : 'hero__images__title'} onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd} onClick={() => openModal(heroTrending[4].id, 'movie')}>{heroTrending[4].title}<span>{heroTrending[4].release_date.split('-', 1)}</span></h3>}
            </div>
